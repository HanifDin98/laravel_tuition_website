	...
	<img src="/img/logo2.png" width="20%" height="10%">
      ...
      <nav id="navbar" class="navbar order-last order-lg-0">
        <ul>
          ...
          <li><a class="nav-link scrollto active" href="/registerA">Package A</a></li>
          <li><a class="nav-link scrollto " href="/registerB">Package B</a></li>
		      <li><a class="nav-link scrollto " href="/registerC">Package C</a></li>
          @auth
...
<section id="contact" class="contact">
  ...
  <h2>Package A </h2>
      ...
      <div>
        ...
        <form id="formpackA" action="{{ url('/registerA') }}" method="POST" onsubmit="return validateForm()">  
          @csrf
          <div class="row">
