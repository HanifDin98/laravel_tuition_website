...
<section id="contact" class="contact">
  ...
  <h2>Package B</h2>
      ...
      <div>
        ...
        <form id="formpackB" action="{{ url('/registerB') }}" method="POST" onsubmit="return validateForm2()">  
          @csrf
          <div class="row">
