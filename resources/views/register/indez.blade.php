	...
	<img src="/img/logo2.png" width="20%" height="10%">
      ...
      <nav id="navbar" class="navbar order-last order-lg-0">
        <ul>
          ...
          <li><a class="nav-link scrollto active" href="#">Register</a></li>
          @auth
...
<section id="contact" class="contact">
  ...
  <h2>{{ $packages->title }}</h2>
      ...
      <div>
        ...
        <form id="formpackA" action="{{ url('/registerz') }}" method="POST" onsubmit="return validateForm{{$packages->id  }}()">  
          @csrf
          <div class="row">
    ...
    <div class="col form-group">
     ...
     <div class="row">
      ...
      <div class="col form-group">
        <div class="row">
        @for ($i = 1; $i <= $packages->core_limit; $i++)
        <div class="col form-group">
            <label>Core Subject</label>
            <select id="subjects" name="subjects{{ $i }}" class="form-control">
        ...
        @for ($i = 1; $i <= $packages->science_limit; $i++)
        <div class="col form-group">
            <label>Sains Subject</label>
            <select id="subjectz" name="subjectz{{ $i }}" class="form-control">
                @foreach ($subjects as $subject)
        ...
        @endfor
          ...
          <div class="text-center"><button type="submit" class="get-started-btn scrollto back" onclick="return submitNotify()">Submit</button></div>
        </form>
    </div>
